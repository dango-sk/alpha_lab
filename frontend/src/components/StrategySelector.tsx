...
export default function StrategySelector({ allKeys, selected, labels, colors, onChange }: StrategySelectorProps) {
  ...
  const dropdown = open && rect && (
    <div
      ...
      className="bg-surface border border-border rounded-lg shadow-xl min-w-[240px] py-1"
    >
        ...
        return (
          ...
          >
            <span
              ...
              style={{ backgroundColor: isSelected ? color : 'transparent', borderColor: isSelected ? color : 'var(--color-border)' }}
            />
